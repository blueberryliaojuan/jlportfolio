      ...
      <main className="flex-1 bg-gray-100 ">
        <div className="py-12">
          ...
          <section className="detail-section hero-section">
            ...
            <div className="md:w-1/2 text-center md:text-left detail-project-text">
          ...
          <section className="detail-section">
            <div className="detail-section-item bg-whitish ">
              <h3 className="heading5 detail-card-title ">Scenario</h3>

              <p className="p mt-2 text-gray-700">
                Ines Piano Academy is a piano school based in Vancouver, Canada,
                founded by Ines, a passionate instructor with over 20 years of
                teaching experience. The academy has been operating for more
                than a decade and offers personalized lessons for students of
                all ages and skill levels. While the school has established a
                strong reputation through word-of-mouth and local presence, its
                digital presence was limited, with no dedicated website or
            ...
            <div className="detail-section-item bg-whitish ">
              ...
              <p className="p font-bold mt-4 text-gray-700">Services Offered</p>
              <p className="p mt-2 text-gray-700">
              ...
              <p className="p mt-2 text-gray-700">
                Some others schools offer group and private lessons with varying
                levels of digital marketing, online presence, and workshop
                events
              </p>
              <p className="p font-bold mt-4 text-gray-700">
          ...
          <section className="detail-section">
            <div className="detail-section-item bg-whitish rounded-lg ">
              ...
              <div className="p mt-2 text-gray-700">
                <ul>
                  ...
                  <li>
                    Elegant and professional design elements for visual appeal.
                  </li>
                </ul>
              </div>
              <p className="p font-bold mt-4 text-gray-700">
              ...
              <p className="p mt-2 text-gray-700">
                Information on workshops, concert opportunities, and examination
                preparation.
              </p>
              <p className="p font-bold mt-4 text-gray-700">Student Showcase</p>
              <p className="p mt-2 text-gray-700">
            ...
            <div className="detail-section-item bg-whitish rounded-lg">
              ...
              <p className="p font-bold mt-4 text-gray-700">SEO Optimization</p>
              <p className="p mt-2 text-gray-700">
              ...
              <div className="p mt-2 text-gray-700">
                <ul>
                  <li>
                    Links to social media platforms for enhanced engagement and
                    reach.
                  </li>
                  <li>
          ...
          <section className="detail-section">
            <div className="detail-section-item bg-whitish rounded-lg">
              ...
              <div className="p mt-2 text-gray-700">
                <ul>
                  ...
                  <li>
                    Managed branches effectively for testing new features before
                    merging.
                  </li>
                </ul>
              </div>
            ...
            <div className="detail-section-item bg-whitish rounded-lg">
              ...
              <div className="p mt-2 text-gray-700">
                <ul>
                  <li>
                    Started with wireframes to outline the website's layout and
                    functionality.
                  </li>
                  <li>
